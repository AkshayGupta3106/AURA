  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={(e) => { e.stopPropagation(); onTryOn(transformation); }}
          className="w-full bg-white text-charcoal rounded-xl py-2 text-xs font-semibold hover:bg-cream transition"
        >
          ✨ Try On Me
        </button>
      </div>
